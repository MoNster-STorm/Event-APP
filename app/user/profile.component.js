...
var ProfileComponent = (function () {
    function ProfileComponent(toastr, authService, router) {
        this.toastr = toastr;
    ...
    ProfileComponent.prototype.saveProfile = function (profileForm) {
    ...
    ProfileComponent.prototype.validateFirstName = function (profileForm) {
        if (this.firstName.invalid && this.firstName.touched)
            return true;
    };
    ProfileComponent.prototype.validateLastName = function (profileForm) {
    ...
    ProfileComponent = __decorate([
        ...
        __metadata('design:paramtypes', [Object, authentication_service_1.AuthService, router_1.Router])
    ], ProfileComponent);
